module Arvore (Arvore(..), minhaArvore, somaElementos, buscaElemento, minimoElemento, ocorrenciasElemento, maioresQueElemento, mediaElementos, quantidade, elementos) where
